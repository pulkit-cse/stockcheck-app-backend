...
const getUser = asyncHandler(async (req,res) => {
    const user = await UserI.findById(req.user._id)
...
const forgotPassword = asyncHandler(async (req,res) => {
    ...
    <p>StockCheck Team</p>
    `;
    const subject = "Password Reset Request for StockCheck"
...
const resetPassword = asyncHandler(async (req,res) => {
    ...
    //Find user
    const user = await UserI.findOne({_id: userToken.userId})
    user.password = password;
    await user.save()
